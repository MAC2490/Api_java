...
public class ApiConsumption {
    public String GetConsumption(String endpoint){
        try {
    ...
    public String GetConsumption(String endpoint, Map<String, String> getData){
        try {
    ...
    public String PostConsumtion(String endpoint){
        try {
            // URL de la API
            URL url = new URL(endpoint);
    ...
    public String PostConsumtion(String endpoint, Map<String, String> postData){
        try {
            // URL de la API
            URL url = new URL(endpoint);
